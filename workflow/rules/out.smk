rule rsync:
    input:
        ...
        bcov = expand("{runid}/results/quality_control/bam/{sample}.bcov.tsv", runid= runid, sample= wts_samples),
        n10cov = expand("{runid}/results/quality_control/bam/{sample}.n10.tsv", runid= runid, sample= wts_samples),
